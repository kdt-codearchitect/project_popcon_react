...
const AllInquiriesComponent = () => {
  ...
  return (
    <div className="myinquiry-page">
      <div className="inquiry-h1">
        <h1> 문의내역 </h1>
      </div>
      <div className="myinquiry-list">
        <div className="myinquiry-list-headers margintop15">
          <div className="myinquiry-list-short m-right">
            <p>순번</p>
          </div>
          <div className="myinquiry-list-long">
            <p>글제목</p>
          </div>
          <div className="myinquiry-list-head">
            <p>작성일자</p>
          </div>
          <div className="myinquiry-list-head">
            <p>처리결과</p>
        ...
        {currentItems.map((customer_qna, idx) => (
          <div className="myinquiry-list-headers margintop10" key={idx}>
            <div className="myinquiry-list-short m-right">
              <p>{myInquiry.length - idx}</p>
            </div>
            <div className="myinquiry-list-long ta-left margintop10">
              <p>
                <Link
                  onClick={() =>
                    openModal(
                ...
                >
                  [{customer_qna.faqType}] {customer_qna.qnaTitle}
                </Link>
              </p>
            </div>
            <div className="myinquiry-list-head">
              <p>{customer_qna.qnaDate}</p>
            </div>
            <div className="myinquiry-list-head">
              <p>{customer_qna.qnaState}</p>
            </div>
            <div className="myinquiry-list-head">
              <p>{customer_qna.qnaClearDate}</p>
            </div>
          </div>
        ))}
        {/* 페이징 매핑 */}
